...
@Component
public class PaySuccessHandler implements PayHandler {
    ...
    public void handler(String skuId, Integer quantity) {
        //预占库存减少，占用库存增加
        inventoryRepository.changeQuantity(InventoryNameSpaceEnum.WITHHOLDING.getRedisNameSpace(skuId), InventoryNameSpaceEnum.OCCUPIED.getRedisNameSpace(skuId), quantity);
    }
}
